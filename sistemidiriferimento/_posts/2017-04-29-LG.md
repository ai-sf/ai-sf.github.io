...
**12.** Si richiede l'invio degli articoli in uno dei seguenti formati: **<font color="red">.doc, .docx, .rtf, .txt</font>**. Tale documento deve contenere unicamente il testo, le figure sono da inviarsi separatamente. Il testo è da inviarsi senza alcuna formattazione particolare in quanto gli articoli sono successivamente impaginati per adattarsi allo stile grafico del presente sito web.
