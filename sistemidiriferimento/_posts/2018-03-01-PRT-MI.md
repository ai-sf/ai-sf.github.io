...
{:.image-caption}
*Figura 1: didascalia. Fonte: [1]. J. M. Campbell, J. W. Huston, W. J. Stirling, Hard Interactions of Quarks and Gluons: A Primer for LHC Physics (http://arxiv.org/abs/hep-ph/0611148)*
...
{:.image-caption}
*Figura 2: J. Gao,  L. Harland-Lang, J. Rojo, The Structure of the Proton in the LHC Precision Era (http://arxiv.org/abs/arXiv:1709.04922)*
...
{:.image-caption}
* manca immagine giusta, figura 4 g(z) = 1/(1+exp(-z))*
...
[1] J. M. Campbell, J. W. Huston, W. J. Stirling, Hard Interactions of Quarks and Gluons: A Primer for LHC Physics (http://arxiv.org/abs/hep-ph/0611148).

[2] S. Forte, Parton distributions at the dawn of the LHC (http://arxiv.org/abs/arXiv:1011.5247).

[3] J. Gao,  L. Harland-Lang, J. Rojo, The Structure of the Proton in the LHC Precision Era (http://arxiv.org/abs/arXiv:1709.04922).

[4] S. Forte, L. Garrido, J.I. Latorre, A. Piccione, Neural network parametrization of deep inelastic structure functions (http://arxiv.org/abs/hep-ph/0204232).

[5] NNPDF collaboration, A Determination of parton distributions with faithful uncertainty estimation (http://arxiv.org/abs/arXiv:0808.1231).
